...
class ProductSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $products = [
            ...
            ['sku' => 'AMX500', 'name' => 'Amoxicillin 500mg', 'name_th' => 'อะม็อกซีซิลลิน 500 มก.', 'generic_name' => 'Amoxicillin', 'category' => 'Antibiotics', 'drug_class' => 'ยาอันตราย', 'manufacturer' => 'GPO Thailand', 'unit_price' => 15.00, 'cost_price' => 8.50, 'stock_qty' => 500, 'min_stock' => 100, 'requires_prescription' => true, 'image_path' => 'https://images.unsplash.com/photo-1584308666744-24d5c474f2ae?w=300'],
            ['sku' => 'AZI250', 'name' => 'Azithromycin 250mg', 'name_th' => 'อะซิโทรมัยซิน 250 มก.', 'generic_name' => 'Azithromycin', 'category' => 'Antibiotics', 'drug_class' => 'ยาอันตราย', 'manufacturer' => 'Siam Pharmaceutical', 'unit_price' => 45.00, 'cost_price' => 30.00, 'stock_qty' => 200, 'min_stock' => 50, 'requires_prescription' => true, 'image_path' => 'https://images.unsplash.com/photo-1584308666744-24d5c474f2ae?w=300'],
            ['sku' => 'CIP500', 'name' => 'Ciprofloxacin 500mg', 'name_th' => 'ไซโปรฟลอกซาซิน 500 มก.', 'generic_name' => 'Ciprofloxacin', 'category' => 'Antibiotics', 'drug_class' => 'ยาอันตราย', 'manufacturer' => 'GPO Thailand', 'unit_price' => 25.00, 'cost_price' => 15.00, 'stock_qty' => 150, 'min_stock' => 30, 'requires_prescription' => true, 'image_path' => 'https://images.unsplash.com/photo-1584308666744-24d5c474f2ae?w=300'],
            ['sku' => 'DOX100', 'name' => 'Doxycycline 100mg', 'name_th' => 'ด็อกซีไซคลิน 100 มก.', 'generic_name' => 'Doxycycline', 'category' => 'Antibiotics', 'drug_class' => 'ยาอันตราย', 'manufacturer' => 'Berlin Pharmaceutical', 'unit_price' => 12.00, 'cost_price' => 6.00, 'stock_qty' => 300, 'min_stock' => 50, 'requires_prescription' => true, 'image_path' => 'https://images.unsplash.com/photo-1584308666744-24d5c474f2ae?w=300'],
            ['sku' => 'ERY500', 'name' => 'Erythromycin 500mg', 'name_th' => 'อีริโทรมัยซิน 500 มก.', 'generic_name' => 'Erythromycin', 'category' => 'Antibiotics', 'drug_class' => 'ยาอันตราย', 'manufacturer' => 'GPO Thailand', 'unit_price' => 18.00, 'cost_price' => 10.00, 'stock_qty' => 180, 'min_stock' => 40, 'requires_prescription' => true, 'image_path' => 'https://images.unsplash.com/photo-1584308666744-24d5c474f2ae?w=300'],

            // Pain Relief (10 products)
            ['sku' => 'PCM500', 'name' => 'Paracetamol 500mg', 'name_th' => 'พาราเซตามอล 500 มก.', 'generic_name' => 'Paracetamol', 'category' => 'Pain Relief', 'drug_class' => 'ยาสามัญประจำบ้าน', 'manufacturer' => 'GPO Thailand', 'unit_price' => 2.00, 'cost_price' => 0.80, 'stock_qty' => 2000, 'min_stock' => 500, 'requires_prescription' => false, 'image_path' => 'https://images.unsplash.com/photo-1584308666744-24d5c474f2ae?w=300'],
            ['sku' => 'IBU400', 'name' => 'Ibuprofen 400mg', 'name_th' => 'ไอบูโพรเฟน 400 มก.', 'generic_name' => 'Ibuprofen', 'category' => 'Pain Relief', 'drug_class' => 'ยาอันตราย', 'manufacturer' => 'Berlin Pharmaceutical', 'unit_price' => 8.00, 'cost_price' => 4.00, 'stock_qty' => 800, 'min_stock' => 200, 'requires_prescription' => false, 'image_path' => 'https://images.unsplash.com/photo-1584308666744-24d5c474f2ae?w=300'],
            ['sku' => 'DIC50', 'name' => 'Diclofenac 50mg', 'name_th' => 'ไดโคลฟีแนค 50 มก.', 'generic_name' => 'Diclofenac', 'category' => 'Pain Relief', 'drug_class' => 'ยาอันตราย', 'manufacturer' => 'Novartis', 'unit_price' => 10.00, 'cost_price' => 5.00, 'stock_qty' => 400, 'min_stock' => 100, 'requires_prescription' => false, 'image_path' => 'https://images.unsplash.com/photo-1584308666744-24d5c474f2ae?w=300'],
            ['sku' => 'MEL7.5', 'name' => 'Meloxicam 7.5mg', 'name_th' => 'เมลอกซิแคม 7.5 มก.', 'generic_name' => 'Meloxicam', 'category' => 'Pain Relief', 'drug_class' => 'ยาอันตราย', 'manufacturer' => 'Boehringer', 'unit_price' => 15.00, 'cost_price' => 8.00, 'stock_qty' => 250, 'min_stock' => 50, 'requires_prescription' => true, 'image_path' => 'https://images.unsplash.com/photo-1584308666744-24d5c474f2ae?w=300'],
            ['sku' => 'NAP500', 'name' => 'Naproxen 500mg', 'name_th' => 'นาพรอกเซน 500 มก.', 'generic_name' => 'Naproxen', 'category' => 'Pain Relief', 'drug_class' => 'ยาอันตราย', 'manufacturer' => 'Bayer', 'unit_price' => 12.00, 'cost_price' => 6.50, 'stock_qty' => 300, 'min_stock' => 60, 'requires_prescription' => false, 'image_path' => 'https://images.unsplash.com/photo-1584308666744-24d5c474f2ae?w=300'],

            // Vitamins & Supplements (10 products)
            ['sku' => 'VITC1000', 'name' => 'Vitamin C 1000mg', 'name_th' => 'วิตามินซี 1000 มก.', 'generic_name' => 'Ascorbic Acid', 'category' => 'Vitamins & Supplements', 'drug_class' => 'อาหารเสริม', 'manufacturer' => 'Mega Lifesciences', 'unit_price' => 15.00, 'cost_price' => 8.00, 'stock_qty' => 300, 'min_stock' => 50, 'requires_prescription' => false, 'image_path' => 'https://images.unsplash.com/photo-1512069772995-ec65ed45afd6?w=300'],
            ['sku' => 'VITB', 'name' => 'Vitamin B Complex', 'name_th' => 'วิตามินบีรวม', 'generic_name' => 'Vitamin B1, B6, B12', 'category' => 'Vitamins & Supplements', 'drug_class' => 'อาหารเสริม', 'manufacturer' => 'Mega Lifesciences', 'unit_price' => 8.00, 'cost_price' => 3.50, 'stock_qty' => 400, 'min_stock' => 100, 'requires_prescription' => false, 'image_path' => 'https://images.unsplash.com/photo-1512069772995-ec65ed45afd6?w=300'],
            ['sku' => 'VITD3', 'name' => 'Vitamin D3 1000IU', 'name_th' => 'วิตามินดี3 1000IU', 'generic_name' => 'Cholecalciferol', 'category' => 'Vitamins & Supplements', 'drug_class' => 'อาหารเสริม', 'manufacturer' => 'Blackmores', 'unit_price' => 12.00, 'cost_price' => 6.00, 'stock_qty' => 250, 'min_stock' => 40, 'requires_prescription' => false, 'image_path' => 'https://images.unsplash.com/photo-1512069772995-ec65ed45afd6?w=300'],
            ['sku' => 'OMEGA3', 'name' => 'Omega-3 Fish Oil', 'name_th' => 'น้ำมันปลาโอเมก้า 3', 'generic_name' => 'Fish Oil', 'category' => 'Vitamins & Supplements', 'drug_class' => 'อาหารเสริม', 'manufacturer' => 'Blackmores', 'unit_price' => 25.00, 'cost_price' => 15.00, 'stock_qty' => 180, 'min_stock' => 30, 'requires_prescription' => false, 'image_path' => 'https://images.unsplash.com/photo-1512069772995-ec65ed45afd6?w=300'],
            ['sku' => 'CALC600', 'name' => 'Calcium 600mg + Vitamin D', 'name_th' => 'แคลเซียม 600 มก.', 'generic_name' => 'Calcium + Vit D', 'category' => 'Vitamins & Supplements', 'drug_class' => 'อาหารเสริม', 'manufacturer' => 'Centrum', 'unit_price' => 18.00, 'cost_price' => 10.00, 'stock_qty' => 200, 'min_stock' => 40, 'requires_prescription' => false, 'image_path' => 'https://images.unsplash.com/photo-1512069772995-ec65ed45afd6?w=300'],
