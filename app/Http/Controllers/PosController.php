    ...
    public function checkAllergies(Request $request)
    {
        ...
        if ($isPregnancyRisky) {
            $alerts[] = [
                ...
                'level' => 'warning',
                'message' => "คำเตือน: ยานี้เป็น 'ยากลุ่มเสี่ยงสำหรับสตรีมีครรภ์' หรือให้นมบุตร กรุณาซักประวัติก่อนจ่าย",
            ];
        }
        ...
        if ($isG6pDRisky) {
            $alerts[] = [
                ...
                'level' => 'danger',
                'message' => "คำเตือนสำคัญ: ยานี้เป็น 'ยากลุ่มเสี่ยงสำหรับผู้ป่วย G6PD' กรุณาตรวจสอบก่อนจ่าย",
            ];
        }
