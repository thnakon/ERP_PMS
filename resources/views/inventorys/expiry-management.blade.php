        ...
        <div class="inv-container">
            <div class="inv-container">
                <div class="inv-breadcrumb-bar">
                    Dashboard / Inventory /
                    <span style="color: #3a3a3c; font-weight: 600;">Expiry Management</span> > <a
                        href="{{ route('inventorys.stock-adjustments') }}" style="color: #017aff"> Stock Adjustments
                    </a>
                </div>
                <div class="inv-header">
                    ...
                    <div class="inv-header-right">
                        <button class="inv-btn-primary" style="background-color: #ff3b30;"
                            onclick="openModal('modal-return')">
                ...
                <div class="inv-filters-wrapper">
                    ...
                    <div style="position: relative; margin-left: 12px;">
                        <input type="text" placeholder="Search Product/Lot..." class="inv-form-input"
                            style="width: 240px; padding-left: 40px; padding-top: 10px; padding-bottom: 10px;">
                    ...
                    <div id="bulk-actions" style="display: none; margin-left: auto; gap: 8px;">
                        ...
                        <button class="inv-btn-secondary" style="font-size: 0.8rem; color: #ff3b30;"><i
                                class="fa-solid fa-trash"></i> Delete / Dispose</button>
                        <button class="inv-btn-secondary" style="font-size: 0.8rem;"
                            onclick="openModal('modal-return')"><i class="fa-solid fa-box"></i> Add to Return</button>
                    </div>
                </div>
                ...
                <div id="section-expired">
                    ...
                    <div class="inv-card-row grid-expiry product-row" data-status="expired"
                        ...
                        <div data-label="Status" style="text-align: right;"><span
                                class="inv-status-badge expired">Expired</span></div>
                    </div>
                </div>
                ...
                <div id="section-near">
                    ...
                    <div class="inv-card-row grid-expiry product-row" data-status="near"
                        ...
                        <div data-label="Status" style="text-align: right;"><span
                                class="inv-status-badge low-stock">Near Expiry</span></div>
                    </div>
                ...
                <div id="section-others">
                    ...
                    <div class="inv-card-row grid-expiry product-row" data-status="good">
                        ...
                        <div data-label="Status" style="text-align: right;"><span
                                class="inv-status-badge active">Good</span></div>
                    </div>
            ...
            <div class="inv-modal-overlay" id="modal-return">
                <div class="inv-modal">
                    ...
                    <div class="inv-modal-body">
                        ...
                        <p style="color: var(--text-secondary); font-size: 0.9rem;">* Selected items will be added to
                            the return list automatically.</p>
                    </div>
