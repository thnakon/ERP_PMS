<x-app-layout>
    ...
    Dashboard / Inventory /
    <span style="color: #3a3a3c; font-weight: 600;">Manage Products</span> > <a href="{{ route('inventorys.categories') }}" style="color: #017aff"> Categories </a>
</div>
            ...
            <div class="inv-filters-wrapper">
                ...
                <div style="position: relative; margin-left: 12px;">
                    <input type="text" id="productSearch" placeholder="Search Name, SKU..." class="inv-form-input"
                        style="width: 280px; padding-left: 40px; padding-top: 10px; padding-bottom: 10px;">
                ...
                <div id="bulk-actions" style="display: none; margin-left: auto; gap: 8px;">
                    ...
                    <button class="inv-btn-secondary" style="font-size: 0.8rem;"><i class="fa-solid fa-barcode"></i>
                        Print Barcode</button>
                    <button class="inv-btn-secondary" style="font-size: 0.8rem; color: #ff3b30;"><i
            ...
            <div id="section-active">
                ...
                <div class="inv-card-row grid-products product-row" data-status="active">
                    ...
                    <div class="inv-action-group" data-label="Actions" style="text-align: right;">
                        <button class="inv-icon-action view" onclick="openModal('modal-view-product')"><i
                                class="fa-solid fa-eye"></i></button>
                        <button class="inv-icon-action edit" onclick="openModal('modal-new-product')"><i
                ...
                <div class="inv-card-row grid-products product-row" data-status="active">
                    ...
                    <div class="inv-text-main" data-label="Stock">12 <span class="inv-text-sub"
                            style="color:#ff9500;">(Low)</span></div>
                ...
                <div class="inv-modal-body">
                    ...
                    <div class="inv-form-group">
                        ...
                        <div class="inv-image-upload-box"
                            ...
                            <img id="inv-image-preview" src="" style="display: none;">

                            <div id="inv-image-placeholder">
                                <div style="font-size: 24px;"><i class="fa-solid fa-camera"></i>
                                </div>
                                <span>Click to upload image</span>
                            </div>

                            <input type="file" id="product-image-input" class="inv-form-input" accept="image/*"
        ...
        <div class="inv-modal-overlay" id="modal-view-product">
            <div class="inv-modal">
                ...
                <div class="inv-modal-body" style="text-align: center;">
                    ...
                    <div
                        style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px; margin-top: 24px; text-align: left; background: #f9f9f9; padding: 20px; border-radius: 16px;">
                        <div>
