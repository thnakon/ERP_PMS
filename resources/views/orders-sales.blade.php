...
<div class="os-container">
    ...
    <div class="os-filters-wrapper">
        ...
        <div class="os-filter-group search">
            ...
            <input type="text" id="search-input" class="os-input" placeholder="เลขที่บิล, เบอร์โทร, หรือชื่อลูกค้า">
        </div>
        ...
        <!-- Refresh Button -->
        <button id="refresh-btn" class="os-icon-button" title="โหลดข้อมูลใหม่"><i class="fa-solid fa-arrows-rotate"></i></button>
    ...
    <div class="os-list-container">
        ...
        <div id="orders-list-body">
            ...
            <div class="os-list-row order-row" data-order-id="1001" onclick="viewOrderDetails('1001')">
                ...
                <div class="os-col os-col-status" data-label="สถานะ"><span class="os-status-badge completed">Completed</span></div>
                <div class="os-col os-col-actions actions-col" data-label="จัดการ">
                    <button class="os-view-btn" onclick="event.stopPropagation(); viewOrderDetails('1001');"><i class="fa-solid fa-eye"></i></button>
                </div>
            </div>
            ...
            <div class="os-list-row order-row" data-order-id="1002" onclick="viewOrderDetails('1002')">
                ...
                <div class="os-col os-col-status" data-label="สถานะ"><span class="os-status-badge refunded">Refunded</span></div>
                <div class="os-col os-col-actions actions-col" data-label="จัดการ">
                    <button class="os-view-btn" onclick="event.stopPropagation(); viewOrderDetails('1002');"><i class="fa-solid fa-eye"></i></button>
                </div>
            </div>
            ...
            <div class="os-list-row order-row" data-order-id="1003" onclick="viewOrderDetails('1003')">
                ...
                <div class="os-col os-col-status" data-label="สถานะ"><span class="os-status-badge cancelled">Cancelled</span></div>
                <div class="os-col os-col-actions actions-col" data-label="จัดการ">
                    <button class="os-view-btn" onclick="event.stopPropagation(); viewOrderDetails('1003');"><i class="fa-solid fa-eye"></i></button>
                </div>
            </div>
            
            <!-- Row for No Results (Hidden by default) -->
            <div id="no-results-row" class="os-list-row" style="display: none; justify-content: center; color: var(--text-secondary);">
...
<div id="order-details-modal" class="os-modal-overlay">
    <div class="os-modal-content">
        ...
        <div class="os-modal-header">
            <div>
                <h2 id="modal-receipt-no"><i class="fa-solid fa-file-invoice os-icon"></i> รายละเอียดบิล #ORD-2025-00123</h2>
                <div class="os-detail-grid">
                    ...
                    <div class="os-detail-item">
                        ...
                        <span id="modal-status" class="os-detail-value os-status-badge completed">Completed</span>
                    </div>
                    <div class="os-detail-item">
        ...
        <div style="display: flex; justify-content: flex-end;">
            ...
            <div style="display: flex; gap: 30px;">
                <div style="min-width: 150px;">
                    <h3 style="font-size: 1rem; margin-top: 0; margin-bottom: 10px; color: var(--text-secondary);">วิธีชำระเงิน</h3>
