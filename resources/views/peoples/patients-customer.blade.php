<x-app-layout>
    ...
    <div class="sr-container">
        ...
        <div class="sr-header">
            <div class="sr-header-left">
                <p class="sr-breadcrumb">Dashboard / People / Patients-Customers</p>
                <h2 class="sr-page-title">Patients | Customers (8)</h2>
            </div>
    ...
    {{-- [!!! EXISTING HEADER !!!] --}}
    {{-- (ส่วนหัวเดิมที่มี Title, Toggle, Buttons) --}}

    <div class="people-content-area">

        {{-- [!!! VIEW 1: LIST VIEW !!!] --}}
        <div id="list-view" class="people-view-wrapper">

            {{-- [!!! REMOVED Search Bar !!!] --}}
            {{-- (ช่องค้นหาถูกลบออกตามคำขอ) --}}
            ...
            <div class="people-list-container">
                ...
                <div class="people-list-row">
                    ...
                    <div class="col-actions">
                        <button class="sr-action-btn" title="View/Edit"><i
        ...
        <div id="activity-view" class="people-view-wrapper">
            <div class="people-grid-view">
                ...
                <div class="people-activity-card">
                    ...
                    <span class="people-badge">Member</span>
                ...
                {{-- Card 2 (Active) --}}
                <div class="people-activity-card">
                    <img src="https://placehold.co/80x80/E2E8F0/4A5568?text=AR" alt="Avatar"
                        class="activity-avatar">
                    <h4 class="activity-name">อารยา รักสงบ</h4>
                    <p class="activity-title">Customer</p>
                    <span class="people-badge">New</span>
                    <div class="people-card-stats">
                        <div class="stat-item"><span class="stat-number">1</span><span
                                class="stat-label">Orders</span></div>
                        <div class="stat-item"><span class="stat-number">0</span><span
                                class="stat-label">Pending</span></div>
                        <div class="stat-item"><span class="stat-number">0</span><span
                                class="stat-label">Notes</span></div>
                    </div>
                ...
                <div class="people-activity-card is-inactive">
                    ...
                    <img src="https://placehold.co/80x80/E2E8F0/4A5568?text=WP" alt="Avatar"
                        class="activity-avatar">
                    <h4 class="activity-name">วิชัย ประเสริฐ</h4>
                    <p class="activity-title">Customer</p>
                    <span class="people-badge">Inactive</span>
                    <div class="people-card-stats">
                        <div class="stat-item"><span class="stat-number">5</span><span
                                class="stat-label">Orders</span></div>
                        <div class="stat-item"><span class="stat-number">0</span><span
                                class="stat-label">Pending</span></div>
                        <div class="stat-item"><span class="stat-number">1</span><span
                ...
                {{-- Card 4 (Active) --}}
                <div class="people-activity-card">
                    <img src="https://placehold.co/80x80/E2E8F0/4A5568?text=KT" alt="Avatar"
                        class="activity-avatar">
                    <h4 class="activity-name">กานดา งามตา</h4>
                    <p class="activity-title">Customer</p>
                    <span class="people-badge">Member</span>
                    <div class="people-card-stats">
                        <div class="stat-item"><span class="stat-number">8</span><span
                                class="stat-label">Orders</span></div>
                        <div class="stat-item"><span class="stat-number">0</span><span
                                class="stat-label">Pending</span></div>
                        <div class="stat-item"><span class="stat-number">1</span><span
                ...
                {{-- Card 5 (Active) --}}
                <div class="people-activity-card">
                    <img src="https://placehold.co/80x80/E2E8F0/4A5568?text=PP" alt="Avatar"
                        class="activity-avatar">
