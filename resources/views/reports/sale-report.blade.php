...
<x-app-layout>
        ...
        <div class="sr-container-s">
            ...
            <div class="sr-header">
                ...
                <div class="sr-header-right">
                    {{-- [!!! ADJUSTED & TRANSLATED !!!] --}}
                    <button class="sr-button-primary" id="btn-add-sale-report">
    ...
    {{-- [!!! NEW: Add Sale Report Modal !!!] --}}
    <div id="modal-add-sale-report" class="sr-modal-overlay">
        <div class="sr-modal">
            <div class="sr-modal-header">
                <h3 class="sr-modal-title">Create New Sales Report</h3>
                <button class="sr-modal-close" data-close="modal-add-sale-report"><i
                        class="fa-solid fa-xmark"></i></button>
            </div>
            <div class="sr-modal-body">
                <form id="form-add-sale-report">
                    <div class="sr-form-group">
                        <label class="sr-form-label">Report Name</label>
                        <input type="text" class="sr-form-input" placeholder="e.g. Monthly Sales - Nov 2025">
                    </div>
                    <div class="sr-form-group">
                        <label class="sr-form-label">Date Range</label>
                    ...
                    <div class="sr-form-group">
                        <label class="sr-form-label">Include Data</label>
                        <div style="display: flex; gap: 12px; flex-wrap: wrap;">
                            ...
                            <label style="display: flex; gap: 6px; align-items: center; font-size: 0.9rem;">
                                <input type="checkbox"> Staff Performance
                            </label>
                        </div>
                    </div>
                    <div class="sr-form-group">
            ...
            <div class="sr-modal-footer">
                <button class="sr-btn-secondary" data-close="modal-add-sale-report">Cancel</button>
