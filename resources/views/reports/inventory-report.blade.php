...
<x-app-layout>
        ...
        <div class="sr-container-i">
            ...
            <div class="sr-header">
             ...
             และใช้คลาสใหม่ sr-button-primary --}}
                    <button class="sr-button-primary" id="btn-add-inventory-report">
    ...
    {{-- [!!! NEW: Add Inventory Report Modal !!!] --}}
    <div id="modal-add-inventory-report" class="sr-modal-overlay">
        <div class="sr-modal">
            <div class="sr-modal-header">
                <h3 class="sr-modal-title">Create Inventory Report</h3>
                <button class="sr-modal-close" data-close="modal-add-inventory-report"><i
                        class="fa-solid fa-xmark"></i></button>
            </div>
            <div class="sr-modal-body">
                <form id="form-add-inventory-report">
                    <div class="sr-form-group">
                        <label class="sr-form-label">Report Type</label>
                        <select class="sr-form-select">
                            <option value="full_list">Full Inventory List</option>
                    ...
                    <div class="sr-form-group">
                        <label class="sr-form-label">Category</label>
                        <select class="sr-form-select">
                            <option value="all">All Categories</option>
            ...
            <div class="sr-modal-footer">
                <button class="sr-btn-secondary" data-close="modal-add-inventory-report">Cancel</button>
