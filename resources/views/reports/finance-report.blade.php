                    ...
                    <div class="sr-widget-card">
                        ...
                        <ul style="display: flex; flex-direction: column; gap: 16px; list-style-type: none; padding: 0;">
                            ...
                            <li style="display: flex; justify-content: space-between; align-items: center; border-bottom: 1px solid var(--border-color); padding-bottom: 12px;">
                                ...
                                <span style="font-weight: 600; font-size: 1rem; color: var(--negative-delta);">(฿100,000.00)</span>
                            </li>
                            <li style="display: flex; justify-content: space-between; align-items: center; padding-top: 8px;">
                                ...
                                <span style="font-weight: 700; font-size: 1.1rem; color: var(--positive-delta);">฿50,000.00</span>
                            </li>
                            ...
                            <table class="sr-table">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>฿20,000</td>
                                        <td>฿20,000</td>
                                        <td><span style="color: var(--positive-delta); font-weight: 600;">50.0%</span></td>
                                    </tr>
                                    <tr>
                                        <td>ยาอันตราย</td>
                                        <td>฿60,000</td>
